...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed w-full top-0 left-0 z-50 py-1 md:py-3.5 transition-colors duration-500 ${navBg || isOpen ? "bg-[#000219] shadow-md" : "bg-transparent"
        }`}
    >
            ...
            <div className="flex items-center md:hidden">
              ...
              >
                ...
                <div className="relative w-6 h-6">
                  {/* Hamburger Icon */}
                  <svg
                    className={`absolute top-0 left-0 transition-opacity duration-300 ${!isOpen ? "opacity-100" : "opacity-0"
                      }`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
